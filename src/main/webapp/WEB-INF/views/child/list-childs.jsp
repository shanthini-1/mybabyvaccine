			...
			<tbody>
				<c:forEach var="child" items="${listAllChilds}">
					<tr>
						...
						<td><a href="/children/childmodifyform?childId=${child.childId}">Edit</a></td>
						<td><a href="/children/childdeleteform?childId=${child.childId}" onclick="return confirm('Are you sure you want to delete child ${child.childId}?');">Delete</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
